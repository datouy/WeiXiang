...
# 否则每个爱笑的人都会被误标成「爱捧场」）。
# 只保留「明确在捧人 / 表达赞赏 / 感恩」的多字词。以下类型已被剔除，因为它们
# 在群聊里几乎从不表示「捧场」，却被当成夸奖导致大量误标：
#   · 同意/确认：就是、是的、没错、对对对、附议、同感、我也是、说得真好(改留)
#   · 许可/应答：可以、好的
#   · 泛喜好/判断：喜欢、真实、真相
# 这些词频繁出现在「活动公告模板」「游戏策略讨论」「日常应答」里，会让人被误标
# 「爱捧场」。真正的捧场必须是针对「人」的赞赏或感恩，方向判定见 insight.py。
POS_WORDS = set(
    """牛逼 厉害 赞 支持 说得对 有道理 确实
    感谢 谢谢 多谢 辛苦 加油 优秀 佩服 高手 大佬 学到了 受教 靠谱 好活 绝了
    说得真好 感动 温暖 好样""".split()
)
